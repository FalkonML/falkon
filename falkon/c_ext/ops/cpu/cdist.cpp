...
static void run_parallel_manhattan(at::Tensor& result, const at::Tensor& t1, const at::Tensor& t2) {
...
void manhattan_dist_kernel(at::Tensor& result, const at::Tensor& x1, const at::Tensor& x2) {
    AT_DISPATCH_FLOATING_TYPES(x1.scalar_type(), "cpu_manhattan", [&] {
        run_parallel_manhattan<scalar_t>(result, x1, x2);
    });
    return mat;
}
