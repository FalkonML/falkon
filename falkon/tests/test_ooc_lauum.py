...
class TestOOCLauum:
    ...
    basic_opt = {
        ...
        'use_cpu': False,
        'max_gpu_mem': 2 * 2**20,  # 10MB to force inner-loop iterations
        'lauum_opt': LauumOptions(lauum_par_blk_multiplier=6),
    }
    ...
    def test_no_blk_mul(self, get_mat, expected_lower):
        ...
        opt = dict(self.basic_opt)
        opt['lauum_opt'] = LauumOptions(lauum_par_blk_multiplier=1)
